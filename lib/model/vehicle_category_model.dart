...
class VehicleData {
  ...
  String? outstation_radius;
  String? outstation_delivery_charge_per_km;
  ...
  VehicleData({
    ...
    this.outstation_radius,
    this.outstation_delivery_charge_per_km,
    this.advanceAmount,
    this.distance,
  });
  ...
  VehicleData.fromJson(Map<String, dynamic> json) {
    ...
    outstation_radius = json['outstation_radius']?.toString() ?? '0.0';
    outstation_delivery_charge_per_km = json['outstation_delivery_charge_per_km']?.toString() ?? '0.0';
distance = json['distance']?.toString() ?? 'Not Available';
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['outstation_radius'] = outstation_radius;
    data['outstation_delivery_charge_per_km'] = outstation_delivery_charge_per_km;
