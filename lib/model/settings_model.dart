...
class SettingsModel {
  ...
  SettingsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? SettingsModelData.fromJson(json['data']) : null;
  }
...
class SettingsModelData {
  ...
  SettingsModelData.fromJson(Map<String, dynamic> json) {
    ...
    initialPaymentPercentage = json['intial_payment_percentage'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['intial_payment_percentage'] = this.initialPaymentPercentage;
