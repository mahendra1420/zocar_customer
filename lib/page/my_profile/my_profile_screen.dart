                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        ButtonThemNew.buildButtonNew(context, title: 'Save Details'.tr, onPress: () async {
                          await myProfileController
                            ...
                            if (value != null) {
                              if (value.success == "success") {
                                ...
                                try {
                                  Get.find<MainPageController>().getUsrData();
                                } catch(e){
  ...
  buildShowDetails({
    ...
    return ListTile(
      ...
      leading: SvgPicture.asset(
        ...
        height: 20,
        colorFilter: ColorFilter.mode(
          textIconColor ?? (AppThemeData.grey900),
          BlendMode.srcIn,
        ),
      ),
      title: Text(
        ...
        style: TextStyle(
          ...
          color: textIconColor ?? (AppThemeData.grey900),
        ),
      ),
      onTap: onPress,
    ...
    return Get.defaultDialog(
      ...
      content: Padding(
        ...
        child: Column(
          ...
          children: [
            TextFieldThemNew.boxBuildTextField(conext: context, hintText: title, controller: controller, validators: validators),
            const SizedBox(
              height: 20,
            ),
            Row(
