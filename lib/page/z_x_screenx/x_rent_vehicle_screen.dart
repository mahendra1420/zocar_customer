...
// import 'package:zocar/controller/rent_vehicle_controller.dart';
...
//             child: ButtonThem.buildButton(context, txtSize: 12, btnHeight: 40, btnWidthRatio: 0.4, title: 'book_now'.tr, btnColor: ConstantColors.yellow, txtColor: Colors.black,
//                 onPress: () {
...
//                           InkWell(
//                             onTap: () {
//                               showDatePicker(context: context, initialDate: controller.startDate.value, firstDate: DateTime.now(), lastDate: DateTime(2040)).then((value) {
//                                 controller.startDate.value = DateTime.parse(DateFormat('yyyy-MM-dd 00:00:00').format(value!));
//                                 if (value.isAfter(controller.endDate.value)) {
...
//                           InkWell(
//                             onTap: () async {
//                               showDatePicker(context: context, initialDate: controller.endDate.value, firstDate: controller.startDate.value, lastDate: DateTime(2040))
//                                   .then((value) {
...
//                         children: [
//                           Expanded(
//                             child: ButtonThem.buildButton(context, btnHeight: 40, title: "send".tr, btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () async {
...
//                                 };
//                                 final res = await controller.bookRentalVehicle(context, bodyParams);
//                                 if (res != null) {
//                                   ShowToastDialog.showToast("Vehicle booked successfully");
...
//                             child: ButtonThem.buildButton(context, btnHeight: 40, title: "cancel".tr, btnColor: ConstantColors.yellow, txtColor: Colors.black, onPress: () {
//                               Navigator.pop(context);
//                             }),
//                           )),
//                         ],
