...
// import 'package:zocar/page/rent_vehicle_screens/rent_vehicle_screen.dart';
...
//
// class HomeControllerSecond extends GetxController with GetSingleTickerProviderStateMixin {
...
//       http.Response response = await LoggingClient(http.Client()).get(Uri.parse('$url?units=metric&origins=$originLat,'
