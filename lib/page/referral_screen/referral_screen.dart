...
import 'package:zocar/controller/referral_controller.dart';
...
class _ReferralScreenState extends State<ReferralScreen> {
  ...
  Future<void> share(ReferralController referralController) async {
    ...
    await Share.share(
      subject: 'ZoCar',
      '\n'
          'Hey there, thanks for choosing ZoCar. Hope you love our product. If you do, share it with your friends using code ${referralController.referralCode.toString()} and get ${Constant().amountShow(amount: referralController.referralAmount.toString())} when ride completed',
    );
  }
}
