...
class MyProfileController extends GetxController {
  ...
  //   try {
  //     ShowToastDialog.showLoader("Please wait");
  //     final response = await LoggingClient(http.Client()).post(Uri.parse(API.updateUserEmail), headers: API.header, body: jsonEncode(bodyParams));
  ...
  Future<dynamic> updateFirstName(Map<String, String> bodyParams) async {
    try {
      ShowToastDialog.showLoader("Please wait");
      final response = await LoggingClient(http.Client()).post(Uri.parse(API.updatePreName), headers: API.header, body: jsonEncode(bodyParams));
      Map<String, dynamic> responseBody = json.safeDecode(response.body);
  ...
  Future<dynamic> updateLastName(Map<String, String> bodyParams) async {
    try {
      ShowToastDialog.showLoader("Please wait");
      final response = await LoggingClient(http.Client()).post(Uri.parse(API.updateLastName), headers: API.header, body: jsonEncode(bodyParams));
  ...
  Future<dynamic> updateAddress(Map<String, String> bodyParams) async {
    try {
      ShowToastDialog.showLoader("Please wait");
      final response = await LoggingClient(http.Client()).post(Uri.parse(API.updateAddress), headers: API.authheader, body: jsonEncode(bodyParams));
  ...
  Future<dynamic> updatePassword(Map<String, String> bodyParams) async {
    try {
      ShowToastDialog.showLoader("Please wait");
      final response = await LoggingClient(http.Client()).post(Uri.parse(API.changePassword), headers: API.header, body: jsonEncode(bodyParams));
  ...
  Future<UserModel?> updateUser({File? image, required String name, required String lname, required String phoneNum, required String email, String? password}) async {
    try {
      ShowToastDialog.showLoader("Please wait");
  ...
  //   try {
  //     ShowToastDialog.showLoader("Please wait");
  //     final response = await LoggingClient(http.Client()).post(Uri.parse(API.editProfile), headers: API.authheader, body: jsonEncode(bodyParams));
  //     Map<String, dynamic> responseBody = json.decode(response.body);
