...
import 'package:zocar/constant/send_notification.dart';
...
class ConversationController extends GetxController {
  ...
  Future<dynamic> getToken(int receiverId) async {
    try {
      ...
      final response = await LoggingClient(http.Client()).post(Uri.parse(API.getFcmToken), headers: API.header, body: jsonEncode(bodyParams));
