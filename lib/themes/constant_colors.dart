...
extension ColorIntensity on Color {
  Color withOpacityLike( double amount) {
    ...
    return Color.fromARGB(
      255,
      (color.red   + (255 - color.red)   * (1 - amount)).round(),
      (color.green + (255 - color.green) * (1 - amount)).round(),
      (color.blue  + (255 - color.blue)  * (1 - amount)).round(),
    );
  }
...
class ConstantColors {
  static Color primary = const Color(0xff072750);
  ...
  static Color blueColorLink = const Color(0xFF0062EB);
  static Color boxColor = const Color(0xFFebeef3);
}
...
class AppThemeData {
  ...
  static Color primary200 = const Color(0XFF2F89FC);
  static Color primary300 = const Color(0XFF184A8B);
  static Color primary300Dark = const Color(0XFF8BBDFE);
  static Color grey50 = const Color(0XFF18181B);
  static Color grey50Dark = const Color(0XFFFAFAFA);
  ...
  static Color error200 = const Color(0XFFD61600);
  static Color error50 = const Color(0XFFFFE8E5);
  static Color blue200 = const Color(0XFFE1F4E5);
  static Color referBgone = const Color(0XFF100018);
  static Color referBgtwo = const Color(0XFF320148);
