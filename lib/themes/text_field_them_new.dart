...
class TextFieldThemNew {
  const TextFieldThemNew(Key? key);
  ...
  static boxBuildTextField({
    ...
    return TextFormField(
        ...
        decoration: InputDecoration(
            ...
            fillColor: AppThemeData.surface50,
            filled: true,
            focusedBorder: OutlineInputBorder(
              borderRadius: const BorderRadius.all(Radius.circular(0)),
              borderSide: BorderSide(color: AppThemeData.grey300, width: 0.8),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          border: Border.all(
        color: borderColor ?? (AppThemeData.grey200),
        width: width,
      )),
      child: TextFormField(
        validator: validators ??
