...
import 'button_them.dart';
import 'constant_colors.dart';

class CustomAlertDialogNew extends StatefulWidget {
  final String title;
  ...
  @override
  CustomAlertDialogNewState createState() => CustomAlertDialogNewState();
}

class CustomAlertDialogNewState extends State<CustomAlertDialogNew> {
  @override
